                ...
                <div className="flex flex-col-reverse lg:flex-row justify-between items-center ">
                    <div className="text-center lg:text-left lg:w-1/2">
                        ...
                        <div className="flex flex-col sm:flex-row gap-6">
                            <a
                                href="#contact"
                                className="border-2 text-center max-lg:p-4  max-lg:hover:scale-105 max-lg:duration-500 border-[#3375FF] p-2 rounded-full w-full sm:w-[200px] bg-[#3375FF] text-white"
                            >
                                {t("Bog’lanish")}
                            </a>
                            <a
